...
(function(root, factory) {
   ...
   * @constructor
   */
  G.Nominatim = function(opt_options) {
    ...
    var defaults = {
      ...
      featureStyle: G.Nominatim.featureStyle,
      lang: 'en-US',
      limit: 5,
      keepOpen: false,
      debug: false
  ...
  G.Nominatim.prototype = {
    createControl: function() {
      ...
      G.Nominatim.elements.input_search.placeholder = this.options.placeholder;
    ...
    listenMapClick: function() {
      ...
      var this_ = this;
      var map_element = G.$base.getMap().getTargetElement();
    ...
    query: function(query) {
      var this_ = this,
        ...
        providers_names = G.Nominatim.providers.names,
    ...
    createFeature: function(obj) {
      var feature = new ol.Feature({
        ...
        feature_style = this.options.featureStyle || G.Nominatim.featureStyle;

      this.addLayer();
      feature.setStyle(feature_style);
      feature.setId(feature_id);
      this.getSource().addFeature(feature);
      G.$base.dispatchEvent({
        type: G.EventType.ADDRESSCHOSEN,
        feature: feature,
    ...
    getProvider: function(options) {
      var params,
        provider = G.Nominatim.providers[options.provider],
        providers_names = G.Nominatim.providers.names,
        requires_key = [
